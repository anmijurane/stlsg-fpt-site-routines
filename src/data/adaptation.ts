export const adaptatio = {
  "routine": {
    "id": "7278ff6867951985342661df1aedf80a",
    "name": "Adaptación",
    "description": "Un plan de 4 niveles que evoluciona de un enfoque de cuerpo completo a una división de torso/pierna, integrando fuerza, cardio y entrenamiento funcional.",
    "disclamer": "",
    "levels": [
      {
        "id": 1,
        ...
        "days": [
          {
            "id": 1,
            "name": "Día 1",
            "focus": "Fuerza - Cuerpo Completo A",
            "exercises": [
          ...
          },
          {
            ...
            "exercises": [
              { "id": "f8a9b2c7", "name": "Cardio a elegir", "series": null, "reps": null, "time": { "value": 30, "unit": "min" }, "muscle": { "name": "Todo el cuerpo", "imgUrl": "" }, "zone": "Cardio", "videoUrl": "", "apparatus": { "name": "Caminadora, elíptica, etc.", "imgUrl": "" } }
            ]
          },
          {
            "id": 3,
            "name": "Día 3",
            "focus": "Fuerza - Cuerpo Completo B",
            "exercises": [
          ...
          },
          {
            ...
            "focus": "Clase Grupal",
            "exercises": [
              { "id": "a7b3c6d9", "name": "Clase de circuito express", "series": null, "reps": null, "time": { "value": 30, "unit": "min" }, "muscle": { "name": "Todo el cuerpo", "imgUrl": "" }, "zone": "Funcional", "videoUrl": "", "apparatus": { "name": "Clase grupal", "imgUrl": "" } }
            ]
          }
        ]
      },
      {
        ...
        "days": [
          ...
          },
          {
            ...
            "focus": "Clase Grupal",
            "exercises": [
              { "id": "e1f5a8b3", "name": "Clase PE&PF", "series": null, "reps": null, "time": { "value": 30, "unit": "min" }, "muscle": { "name": "Todo el cuerpo", "imgUrl": "" }, "zone": "Funcional", "videoUrl": "", "apparatus": { "name": "Clase grupal", "imgUrl": "" } }
            ]
          }
        ]
      },
