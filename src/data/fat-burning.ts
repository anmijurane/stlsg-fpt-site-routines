export const fat_burning = {
  "routine": {
    "id": "b9bdcfd8d804d8eaf2b97c1d87f4b097",
    "name": "Quema de grasa",
    "description": "Un plan de 4 niveles basado en intervalos de alta intensidad (HIIT) y circuitos para maximizar la resistencia cardiovascular y muscular.",
    "levels": [
      {
        "id": 1,
        "name": "Nivel 1",
