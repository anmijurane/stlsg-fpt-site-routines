export const muscle_gain = {
  "routine": {
    "id": "54be984e69b80a2edce88a86c11ece85",
    "name": "Ganancia muscular",
    "description": "Un plan de 4 niveles diseñado para maximizar la fuerza y el volumen muscular, estructurado con días de descanso estratégicos.",
    "disclamer": "",
    "levels": [
      {
        "id": 1,
        ...
        "days": [
          ...
          },
          {
            ...
            "focus": "Clase Grupal",
            "exercises": [
              { "id": "w4x5y6z7", "name": "Clase PE&PF", "series": null, "reps": 1, "time": { "value": 0, "unit": "Libre" }, "muscle": { "name": "Todo el cuerpo", "imgUrl": "" }, "zone": "Funcional", "videoUrl": "", "apparatus": { "name": "Clase grupal", "imgUrl": "" } }
            ]
          }
        ]
      },
